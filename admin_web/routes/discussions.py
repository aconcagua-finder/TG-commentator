...
async def discussions_new_submit(
    ...
    if form is not None:
        ...
        scene_operator_quote_mode_list = list(form.getlist("scene_operator_quote_mode"))
        ...
        scene_lists = [
            ...
            scene_operator_quote_mode_list,
            scene_vector_list,
        ...
        for i in range(max_len):
            ...
            sqm = (scene_operator_quote_mode_list[i] if i < len(scene_operator_quote_mode_list) else "") or ""
            ...
            sqm = str(sqm or "").strip()
            if sqm not in ("operator_prev", "last_reply", "none"):
                sqm = "operator_prev"
...
async def discussion_target_edit_save(
    ...
    scene_operator_quote_mode: Optional[List[str]] = Form(None),
    ...
    if (
        ...
        or scene_operator_quote_mode is not None
        ...
        for i in range(max_len):
            ...
            sqm = (
                (scene_operator_quote_mode[i] if scene_operator_quote_mode and i < len(scene_operator_quote_mode) else "")
                or ""
            )
